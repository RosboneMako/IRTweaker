...
public:
    ...
    int GEQ_BW_Mode = 2;             //R1.10 GEQ Bandwidth(Q) setting 0-.7, 1-1.4, 2-2, 3-4
...
private:
    ...
    void Filter_Calc_BiQuad_Clear(int channel, tp_filter* fn);
    ...
    void Buffers_Clear(int channel);
