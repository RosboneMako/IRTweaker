...
private:
    ...
    makoRect rcKillIR =  { 647, 17, 717, 37 }; 
    makoRect rcKillEQ =  { 647, 37, 717, 57 };
    makoRect rcKillGEQ = { 647, 57, 717, 77 };
    ...
    {   
        ...
        "IR1 DISTANCE: Adjust the IR start to align the IR phasing (mic distance).",
        "IR2 DISTANCE: Adjust the IR start to align the IR phasing (mic distance).",
        "IR1 VOLUME: Adjust how loud IR1 will be.",
        "IR2 VOLUME: Adjust how loud IR2 will be.",
